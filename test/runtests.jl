...
@testset "25. Extreme Scaling Variants" begin
    # KORREKTUR: Reduziert auf 1e3. Cond ~ 1e6 ist sicher für Float64.
    # Frühere Werte (1e10) führten zu Konditionszahlen jenseits der Float64 Genauigkeit.
    A_scale = [1e3 0.0; 0.0 1e-3]
    b_scale = [1e3, 1e-3]
    ...
    Random.seed!(1000)
    n = 5
    # Begrenzt Exponenten auf +/- 3, um Cond < 1e7 zu halten
